...
namespace practic
{
    public partial class Serpent : Window
    {
        public Serpent()
        {
            InitializeComponent();
        ...
        private void Encrypt_Click(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                try
                {
                    mainWindow.cryptText.Text = SERPENTEncryptor.SERPENTEncryption(mainWindow.sourceText.Text, Key.Text);
        ...
        private void Decrypt_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                {
                    mainWindow.cryptText.Text = SERPENTEncryptor.SERPENTDecryption(mainWindow.sourceText.Text, Key.Text);
                    Text.Foreground = new SolidColorBrush(Colors.Black);
                    Text.FontSize = 14;
                    Text.Text = mainWindow.cryptText.Text;
                }
